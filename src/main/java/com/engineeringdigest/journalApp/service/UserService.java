...
//    private static final Logger logger = LoggerFactory.getLogger(UserService.class);
    ...
    public boolean saveNewUser(User user) {
        try{
            ...
            log.error(""); // used when we use slf4j annotation
//            logger.error("test logger for :{}",user.getUserName(),e );  we will be using these statement when we are creating a object and then using it .
            return false;
        }
